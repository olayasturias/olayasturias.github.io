...
start_jekyll() {
    ...
    bundle exec jekyll serve --watch --port=8080 --host=0.0.0.0 --livereload --verbose --trace --force_polling --unpublished --destination "$DOCKER_DESTINATION" --config "$CONFIG_FILE" &
}
