...
description: Talks and outreach activities for the general public, universities, and conferences
img: assets/images/pint-of-science/chihuahuaormuffin.png
importance: 1
category: outreach
---
...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include video.liquid path="https://www.youtube.com/embed/Sey5MNKqODQ" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
<div class="row justify-content-sm-center">
  <div class="col-sm-8 mt-3 mt-md-0">
    {% include figure.liquid path="assets/images/dissemination/maiind.png" title="Talk at MAIIND, Polytechnic School of Gijón" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
